...
for model in ["facebook/detr-resnet-101", "hustvl/yolos-tiny", "microsoft/table-transformer-detection"]:
    object_detection_pipe = pipeline("object-detection", model=model)
